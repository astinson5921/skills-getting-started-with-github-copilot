...
activities = {
    ...
    "Basketball Team": {
        ...
        "schedule": "Tuesdays, Thursdays, and Saturdays, 3:00 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["tyler@mergington.edu", "marcus@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Play recreational and competitive soccer with fellow students",
